...
# ---------------------------------------------------------------------------
# Utilitário de gráfico — fecha a figura após renderizar
# ---------------------------------------------------------------------------
def bar_chart(series: pd.Series, title: str, xlabel: str = "", ylabel: str = "", color: str = "skyblue"):
    fig, ax = plt.subplots()
...
# ---------------------------------------------------------------------------
    ...
    if df_filtered.empty:
        ...
        bar_chart(country_city.head(5), "Top 5 Países com Mais Cidades", "País", "Cidades")
        ...
        bar_chart(country_rest, "Top 5 Países com Mais Restaurantes", "País", "Restaurantes")
        ...
        if not price4.empty:
            ...
            bar_chart(cp4, "Top 5 Países — Restaurantes Nível 4", "País", "Restaurantes", "salmon")
        ...
        bar_chart(cost_country, "Top 5 — Maior Preço Médio p/ Dois", "País", "Preço Médio")
...
# ---------------------------------------------------------------------------
    ...
    if df_filtered.empty:
        ...
        bar_chart(cuis_city, "Top 5 Cidades — Tipos de Culinária", "Cidade", "Tipos")
